# Contributing to FlatMessage

Thank you for considering contributing to FlatMessage! Here are some guidelines to help you get started:
...
2. **Clone Your Fork**  
   ...
   ```bash
   git clone https://github.com/gdt050579/FlatMessage.git
   ```
...
Thank you for contributing to FlatMessage! 🎉
